...
@section('title', 'Create SEO Tag')
@section('content')
    <div class="card mb-4">
        <div class="card-header">
            <h2>Create SEO Tag</h2>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.seo.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('robots') is-invalid @enderror"
                                           id="robots" name="robots" value="{{ old('robots') }}">
                                    @error('robots')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="accordion-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('og_description') is-invalid @enderror"
                                              id="og_description"
                                              name="og_description">{{ old('og_description') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('og_url') is-invalid @enderror"
                                           id="og_url" name="og_url" value="{{ old('og_url') }}">
                                    @error('og_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="accordion-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('twitter_card') is-invalid @enderror"
                                           id="twitter_card" name="twitter_card" value="{{ old('twitter_card') }}">
                                    @error('twitter_card')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="accordion-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('schema_type') is-invalid @enderror"
                                           id="schema_type" name="schema_type" value="{{ old('schema_type') }}">
                                    @error('schema_type')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('schema_name') is-invalid @enderror"
                                           id="schema_name" name="schema_name" value="{{ old('schema_name') }}">
                                    @error('schema_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('schema_description') is-invalid @enderror"
                                              ...
                                              name="schema_description">{{ old('schema_description') }}</textarea>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="url" class="form-control @error('schema_url') is-invalid @enderror"
                                           id="schema_url" name="schema_url" value="{{ old('schema_url') }}">
                                    @error('schema_url')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('json_ld') is-invalid @enderror"
                                              id="json_ld" name="json_ld">{{ old('json_ld') }}</textarea>
                                    @error('json_ld')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                ...
                <button type="submit" class="btn btn-primary">Create SEO Tag</button>
            </form>
        </div>
    </div>
@endsection
